...
<body>
	<!-- 
	 ...
	 <!-- 버튼을 클릭했을 때 메인페이지(home)로 넘어가도록 해야 한다.
	 	앞으로는 urlpattern 뒤에 .do가 붙으면 DispatcherServlet이 실행되도록 할 것이다.
